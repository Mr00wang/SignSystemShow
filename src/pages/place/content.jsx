    ...
    render() {
        ...
        return(
            <div className="drawer-body">
                ...
                <div className="row1">
                    <div className="column" id={"seat1"} onClick={() => this.sign(seat1===undefined ? "" : seat1.memberName,"seat1",seat1===undefined ? "" : seat1.state)} style={{backgroundColor:seat1 === undefined ? '#E7815B' : (seat1.state===0 ? '#E7815B' : '#94FA09')}}>
                    ...
                    <div className="column" id={"seat2"} onClick={() => this.sign(seat2===undefined ? "" : seat2.memberName,"seat2",seat2===undefined ? "" : seat2.state)} style={{backgroundColor:seat2 === undefined ? '#E7815B' : (seat2.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat2===undefined ? "" : seat2.seat+'、'+seat2.memberName}</span><br/>
                            <span>{seat2===undefined ? "" : seat2.totalTime+' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat3"} onClick={() => this.sign(seat3===undefined ? "" : seat3.memberName,"seat3",seat3===undefined ? "" : seat3.state)} style={{backgroundColor:seat3 === undefined ? '#E7815B' : (seat3.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat3===undefined ? "" : seat3.seat+'、'+seat3.memberName}</span><br/>
                            <span>{seat3===undefined ? "" : seat3.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat4"} onClick={() => this.sign(seat4===undefined ? "" : seat4.memberName,"seat4",seat4===undefined ? "" : seat4.state)} style={{backgroundColor:seat4 === undefined ? '#E7815B' : (seat4.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat4===undefined ? "" : seat4.seat+'、'+seat4.memberName}</span><br/>
                            <span>{seat4===undefined ? "" : seat4.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat5"} onClick={() => this.sign(seat5===undefined ? "" : seat5.memberName,"seat5",seat5===undefined ? "" : seat5.state)} style={{backgroundColor:seat5 === undefined ? '#E7815B' : (seat5.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat5===undefined ? "" : seat5.seat+'、'+seat5.memberName}</span><br/>
                            <span>{seat5===undefined ? "" : seat5.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat6"} onClick={() => this.sign(seat6===undefined ? "" : seat6.memberName,"seat6",seat6===undefined ? "" : seat6.state)} style={{backgroundColor:seat6 === undefined ? '#E7815B' : (seat6.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat6===undefined ? "" : seat6.seat+'、'+seat6.memberName}</span><br/>
                            <span>{seat6===undefined ? "" : seat6.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat7"} onClick={() => this.sign(seat7===undefined ? "" : seat7.memberName,"seat7",seat7===undefined ? "" : seat7.state)} style={{backgroundColor:seat7 === undefined ? '#E7815B' : (seat7.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat7===undefined ? "" : seat7.seat+'、'+seat7.memberName}</span><br/>
                            <span>{seat7===undefined ? "" : seat7.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat8"} onClick={() => this.sign(seat8===undefined ? "" : seat8.memberName,"seat8",seat8===undefined ? "" : seat8.state)} style={{backgroundColor:seat8 === undefined ? '#E7815B' : (seat8.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat8===undefined ? "" : seat8.seat+'、'+seat8.memberName}</span><br/>
                            <span>{seat8===undefined ? "" : seat8.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat9"} onClick={() => this.sign(seat9===undefined ? "" : seat9.memberName,"seat9",seat9===undefined ? "" : seat9.state)} style={{backgroundColor:seat9 === undefined ? '#E7815B' : (seat9.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat9===undefined ? "" : seat9.seat+'、'+seat9.memberName}</span><br/>
                            <span>{seat9===undefined ? "" : seat9.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat10"} onClick={() => this.sign(seat10===undefined ? "" : seat10.memberName,"seat10",seat10===undefined ? "" : seat10.state)} style={{backgroundColor:seat10 === undefined ? '#E7815B' : (seat10.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat10===undefined ? "" : seat10.seat+'、'+seat10.memberName}</span><br/>
                            <span>{seat10===undefined ? "" : seat10.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat11"} onClick={() => this.sign(seat11===undefined ? "" : seat11.memberName,"seat11",seat11===undefined ? "" : seat11.state)} style={{backgroundColor:seat11 === undefined ? '#E7815B' : (seat11.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat11===undefined ? "" : seat11.seat+'、'+seat11.memberName}</span><br/>
                            <span>{seat11===undefined ? "" : seat11.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat12"} onClick={() => this.sign(seat12===undefined ? "" : seat12.memberName,"seat12",seat12===undefined ? "" : seat12.state)} style={{backgroundColor:seat12 === undefined ? '#E7815B' : (seat12.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat12===undefined ? "" : seat12.seat+'、'+seat12.memberName}</span><br/>
                            <span>{seat12===undefined ? "" : seat12.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat13"} onClick={() => this.sign(seat13===undefined ? "" : seat13.memberName,"seat13",seat13===undefined ? "" : seat13.state)} style={{backgroundColor:seat13 === undefined ? '#E7815B' : (seat13.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat13===undefined ? "" : seat13.seat+'、'+seat13.memberName}</span><br/>
                            <span>{seat13===undefined ? "" : seat13.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat14"} onClick={() => this.sign(seat14===undefined ? "" : seat14.memberName,"seat14",seat14===undefined ? "" : seat14.state)} style={{backgroundColor:seat14 === undefined ? '#E7815B' : (seat14.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat14===undefined ? "" : seat14.seat+'、'+seat14.memberName}</span><br/>
                            <span>{seat14===undefined ? "" : seat14.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat15"} onClick={() => this.sign(seat15===undefined ? "" : seat15.memberName,"seat15",seat15===undefined ? "" : seat15.state)} style={{backgroundColor:seat15 === undefined ? '#E7815B' : (seat15.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat15===undefined ? "" : seat15.seat+'、'+seat15.memberName}</span><br/>
                            <span>{seat15===undefined ? "" : seat15.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat16"} onClick={() => this.sign(seat16===undefined ? "" : seat16.memberName,"seat16",seat16===undefined ? "" : seat16.state)} style={{backgroundColor:seat16 === undefined ? '#E7815B' : (seat16.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                ...
                <div className="row2">
                    <div className="column" id={"seat17"} onClick={() => this.sign(seat17===undefined ? "" : seat17.memberName,"seat17",seat17===undefined ? "" : seat17.state)} style={{backgroundColor:seat17 === undefined ? '#E7815B' : (seat17.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat17===undefined ? "" : seat17.seat+'、'+seat17.memberName}</span><br/>
                            <span>{seat17===undefined ? "" : seat17.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat18"} onClick={() => this.sign(seat18===undefined ? "" : seat18.memberName,"seat18",seat18===undefined ? "" : seat18.state)} style={{backgroundColor:seat18 === undefined ? '#E7815B' : (seat18.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat18===undefined ? "" : seat18.seat+'、'+seat18.memberName}</span><br/>
                            <span>{seat18===undefined ? "" : seat18.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat19"} onClick={() => this.sign(seat19===undefined ? "" : seat19.memberName,"seat19",seat19===undefined ? "" : seat19.state)} style={{backgroundColor:seat19 === undefined ? '#E7815B' : (seat19.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat19===undefined ? "" : seat19.seat+'、'+seat19.memberName}</span><br/>
                            <span>{seat19===undefined ? "" : seat19.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat20"} onClick={() => this.sign(seat20===undefined ? "" : seat20.memberName,"seat20",seat20===undefined ? "" : seat20.state)} style={{backgroundColor:seat20 === undefined ? '#E7815B' : (seat20.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat20===undefined ? "" : seat20.seat+'、'+seat20.memberName}</span><br/>
                            <span>{seat20===undefined ? "" : seat20.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat21"} onClick={() => this.sign(seat21===undefined ? "" : seat21.memberName,"seat21",seat21===undefined ? "" : seat21.state)} style={{backgroundColor:seat21 === undefined ? '#E7815B' : (seat21.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat21===undefined ? "" : seat21.seat+'、'+seat21.memberName}</span><br/>
                            <span>{seat21===undefined ? "" : seat21.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat22"} onClick={() => this.sign(seat22===undefined ? "" : seat22.memberName,"seat22",seat22===undefined ? "" : seat22.state)} style={{backgroundColor:seat22 === undefined ? '#E7815B' : (seat22.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat22===undefined ? "" : seat22.seat+'、'+seat22.memberName}</span><br/>
                            <span>{seat22===undefined ? "" : seat22.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat23"} onClick={() => this.sign(seat23===undefined ? "" : seat23.memberName,"seat23",seat23===undefined ? "" : seat23.state)} style={{backgroundColor:seat23 === undefined ? '#E7815B' : (seat23.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat23===undefined ? "" : seat23.seat+'、'+seat23.memberName}</span><br/>
                            <span>{seat23===undefined ? "" : seat23.totalTime+ ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat24"} onClick={() => this.sign(seat24===undefined ? "" : seat24.memberName,"seat24",seat24===undefined ? "" : seat24.state)} style={{backgroundColor:seat24 === undefined ? '#E7815B' : (seat24.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat24===undefined ? "" : seat24.seat+'、'+seat24.memberName}</span><br/>
                            <span>{seat24===undefined ? "" : seat24.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat25"} onClick={() => this.sign(seat25===undefined ? "" : seat25.memberName,"seat25",seat25===undefined ? "" : seat25.state)}  style={{backgroundColor:seat25 === undefined ? '#E7815B' : (seat25.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat25===undefined ? "" : seat25.seat+'、'+seat25.memberName}</span><br/>
                            <span>{seat25===undefined ? "" : seat25.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat26"} onClick={() => this.sign(seat26===undefined ? "" : seat26.memberName,"seat26",seat26===undefined ? "" : seat26.state)}  style={{backgroundColor:seat26 === undefined ? '#E7815B' : (seat26.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat26===undefined ? "" : seat26.seat+'、'+seat26.memberName}</span><br/>
                            <span>{seat26===undefined ? "" : seat26.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat27"} onClick={() => this.sign(seat27===undefined ? "" : seat27.memberName,"seat27",seat27===undefined ? "" : seat27.state)}  style={{backgroundColor:seat27 === undefined ? '#E7815B' : (seat27.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat27===undefined ? "" : seat27.seat+'、'+seat27.memberName}</span><br/>
                            <span>{seat27===undefined ? "" : seat27.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat28"} onClick={() => this.sign(seat28===undefined ? "" : seat28.memberName,"seat28",seat28===undefined ? "" : seat28.state)}  style={{backgroundColor:seat28 === undefined ? '#E7815B' : (seat28.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat28===undefined ? "" : seat28.seat+'、'+seat28.memberName}</span><br/>
                            <span>{seat28===undefined ? "" : seat28.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat29"} onClick={() => this.sign(seat29===undefined ? "" : seat29.memberName,"seat29",seat29===undefined ? "" : seat29.state)}  style={{backgroundColor:seat29 === undefined ? '#E7815B' : (seat29.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat29===undefined ? "" : seat29.seat+'、'+seat29.memberName}</span><br/>
                            <span>{seat29===undefined ? "" : seat29.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat30"} onClick={() => this.sign(seat30===undefined ? "" : seat30.memberName,"seat30",seat30===undefined ? "" : seat30.state)}  style={{backgroundColor:seat30 === undefined ? '#E7815B' : (seat30.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat30===undefined ? "" : seat30.seat+'、'+seat30.memberName}</span><br/>
                            <span>{seat30===undefined ? "" : seat30.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat31"} onClick={() => this.sign(seat31===undefined ? "" : seat31.memberName,"seat31",seat31===undefined ? "" : seat31.state)}  style={{backgroundColor:seat31 === undefined ? '#E7815B' : (seat31.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
                            <span> {seat31===undefined ? "" : seat31.seat+'、'+seat31.memberName}</span><br/>
                            <span>{seat31===undefined ? "" : seat31.totalTime + ' min'}</span>
                        </div>
                    </div>
                    <div className="column" id={"seat32"} onClick={() => this.sign(seat32===undefined ? "" : seat32.memberName,"seat32",seat32===undefined ? "" : seat32.state)}  style={{backgroundColor:seat32 === undefined ? '#E7815B' : (seat32.state===0 ? '#E7815B' : '#94FA09')}}>
                        <div className="single-data">
